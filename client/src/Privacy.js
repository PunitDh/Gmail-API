          ...
          <div data-exp="simple2" className="outputVersion1">
            ...
            >
              <span style={{ fontStyle: "normal", fontWeight: "bold" }}>
                "Gmail Bulk Delete API" Privacy Policy
              </span>
            </p>
            <p
              style={{
            ...
            >
              "Gmail Bulk Delete API" (the "Site") is owned and operated by
              Punit Dharmadhikari. Punit Dharmadhikari can be contacted at:{" "}
              <br />
              <br />
              punit04@gmail.com
              <br />
