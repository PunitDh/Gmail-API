        ...
        <div data-exp="simple2" className="outputVersion1">
          <div className=" header">
            ...
            <span style={{ lineHeight: "18.0pt" }} className="pageNumbers">
              Page <span className="currentPageNum" /> of{" "}
              <span className="totalPageNum" />
            </span>
          </div>
          ...
          >
            __________ (the "Site") is owned and operated by Punit
            Dharmadhikari. Punit Dharmadhikari can be contacted at: <br />
            <br />
            punit04@gmail.com
            <br />
            (04) 6875 7015
          ...
          >
            <li value={1}>
              <span>First and last name; and</span>
              <span style={{ color: "#000000" }}>
                <br />
              </span>
            </li>
          ...
          <div>
            ...
            >
              ...
              under 16 years of age. If we learn that we have collected personal
              data from a child under 16 years of age, the personal data will be
          ...
          >
            ...
            our privacy officer, Punit Dharmadhikari, at:
            <br />
            <br />
            punit04@gmail.com
            <br />
